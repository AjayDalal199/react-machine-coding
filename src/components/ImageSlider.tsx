...
const ImageSlider = () => {
  ...
  return (
    <div className="w-full aspect-square border border-dashed border-red-400 flex flex-col gap-4 items-center">
      <div className="w-full border-2 border-solid border-amber-300 mx-auto relative h-auto">
        <div
          className="absolute top-1/2 left-0 rounded-full bg-amber-600 text-base md:text-2xl h-8 w-8  md:h-16 md:w-16  font-medium md:font-bold flex items-center justify-center cursor-pointer"
        ...
        <div
          className="absolute top-1/2 right-0 rounded-full bg-amber-600 text-base md:text-2xl h-8 w-8 md:h-16 md:w-16  font-medium md:font-bold flex items-center justify-center cursor-pointer"
